...
export const Route = createFileRoute("/media")({
  head: () => ({
    meta: [
      { title: "Media — Stories & Guidance | Nelsen Savannah" },
      {
        name: "description",
        content:
          "Articles and media from mentors — career paths, interview technique, mentorship and money habits.",
      },
      { property: "og:title", content: "Media | Nelsen Savannah" },
    ],
  }),
  component: MediaPage,
});
  ...
  return (
    <div className="pb-24 pt-32 sm:pt-40">
      <header className="mx-auto max-w-7xl px-5 sm:px-8">
        <p className="eyebrow text-ember">Media</p>
