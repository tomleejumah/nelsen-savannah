...
export const LMS_TOOLS: LmsTool[] = [
  ...
  },
  {
    ...
    blurb: "Create and update tracks, modules, lessons",
    to: "/teach",
    hash: "cms",
    shells: ["mentor", "school", "admin"],
  },
  {
    id: "add",
    label: "Add to course",
    blurb: "Video, PDF, course assignment, or milestone",
    to: "/teach",
    hash: "add",
    shells: ["mentor", "school", "admin"],
  },
  {
    id: "cockpit",
    label: "Course cockpit",
    blurb: "Students and assignment completion",
    to: "/teach",
    hash: "cockpit",
    shells: ["mentor", "school", "admin"],
  },
